import {TableKey, TableStructure} from '../types/types';
  ...
  tables: {
    ...
    enrollments: {
        ...
        columns: {
          ...
          subject_name: { type: 'string', label: 'Nombre de Materia / Subject Name:', editable: false, derivable: {originTable: 'subjects', sqlGenerationStatement: `entityName.name`}},
